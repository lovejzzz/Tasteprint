...
const SEMANTIC_RESPONSES = {
  ...
  share_fears: ["honestly? being forgotten. or spiders. both valid","oh hmm, let me think","i think everyone's afraid of something, it's what makes us human"],
...
const ASSOC = {
  ...
  figma:      { related:["design","prototype","ui","components","variables"], opinions:["it made design tools accessible to everyone","auto layout changed everything","the plugin ecosystem is so good"], hooks:["do you use variables for theming?","how do you organize your component library?","dev mode or inspect?"] },
  ...
  sushi:      { related:["japanese","fish","rice","food","restaurant"], opinions:["fresh sushi hits on a different level","quality varies so much with sushi, good sushi is unreal","omakase is the move, just trust the chef"], hooks:["nigiri or rolls?","do you have a favorite sushi spot?","best piece of sushi you've ever had?"] },
  ...
  film:       { related:["movie","cinema","director","cinematography"], opinions:["cinematography tells the story without words honestly","indie films take the wildest creative risks","a great soundtrack makes a good film unforgettable fr"], hooks:["who's your favorite director?","indie or blockbusters?","what genre draws you in?"] },
  ...
  ai:         { related:["ml","gpt","llm","chatbot","automation","deep learning"], opinions:["AI is wild rn, the pace of progress is insane","it's a tool tho, the magic is how people use it","honestly we're living through the biggest tech shift ever"], hooks:["are you building with AI or just watching the space?","what's the craziest AI thing you've seen?","do you think about how AI affects your work?"], facts:["GPT-4 was trained on trillions of tokens","AI can write code, make art, compose music now","the transformer architecture changed everything in NLP"] },
