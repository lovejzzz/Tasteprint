...
export const DEFAULT_PROPS = {
  ...
  checkbox:      { checked: [true, false, false], animated: true },
  tabs:          { active: 0, showIcon: true, animated: true },
  navbar:        { active: 0, showCta: true, animated: true },
  sidebar:       { active: 0, collapsed: false, animated: true },
  pagination:    { active: 2, total: 8, showTotal: true, animated: true },
  stepper:       { active: 1, showLabels: true, animated: true },
  timeline:      { active: 0, completed: [true, false, false], animated: true },
  accordion:     { open: [true, false, false], showIcon: true, animated: true },
  dropdown:      { active: 0, disabled: false, showFlags: true, animated: true },
  "cmd-palette": { active: 0, open: true, animated: true },
  ...
  "dash-panel":  { bars: [65,42,78,35,55,88,48], ring: 72, animated: true },
  chart:         { bars: [55,80,45,90,65,75], highlight: 3, animated: true, showLegend: true },
  notification:  { read: [false, false, true], muted: false, showHeader: true, animated: true },
  alert:         { level: 0, dismissed: false, showAction: true, animated: true },
  toast:         { level: 0, dismissed: false, actionable: true, animated: true },
  "pricing-card":{ featured: false, period: 0, annual: false, highlighted: false, animated: true },
  "product-card":{ wishlisted: false, rating: 4, inCart: false, onSale: false, soldOut: false, animated: true },
  "profile-card":{ online: true, verified: true, followed: false, showBio: true, animated: true },
  kanban:        { active: 1, compact: false, animated: true },
  skeleton:      { loading: true, animated: true },
  "bento-grid":  { active: 0, animated: true },
  "feature-table":{ highlight: 1, compact: false, animated: true },
  "cart-item":   { qty: 1, saved: false, animated: true },
  receipt:       { tip: 0, paid: 1, animated: true },
  "order-summary":{ discount: false, shipping: 0, animated: true },
  "promo-banner":{ dismissed: false, closable: true, animated: true },
  table:         { highlight: 0, sortCol: -1, sortable: true, animated: true },
  card:          { featured: false, liked: false, loading: false, animated: true },
  badge:         { level: 0, count: 3, dot: false, animated: true },
  modal:         { on: true, size: 1, dismissible: true, animated: true },
  "stat-card":   { trend: 0, sparkline: true, showDelta: true, animated: true },
  "list-item":   { on: true, pinned: false, completed: false, animated: true },
  "avatar-row":  { active: 0, stacked: true, animated: true },
  "tag-input":   { active: 0, removable: true, editable: true, animated: true },
  "card-sm":     { featured: false, showBadge: true, animated: true },
  footer:        { active: 0, newsletter: false, subscribed: false, showSocials: true, animated: true },
  hero:          { active: 0, centered: true, showTrust: true, animated: true },
  toggle:        { on: true, animated: true },
  button:        { loading: false, disabled: false, icon: false, animated: true },
  navbar:        { active: 0, showCta: true, animated: true },
  breadcrumb:    { active: 2, collapsed: false, animated: true },
  input:         { focused: false, error: false, disabled: false, success: false, animated: true },
