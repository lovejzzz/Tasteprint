...
export const DEFAULT_PROPS = {
  ...
  testimonial:   { stars: 4, verified: 1, animated: true },
  ...
  "profile-card":{ online: true, verified: true, followed: false, animated: true },
  ...
  "card-sm":     { featured: false, animated: true },
  footer:        { active: 0, newsletter: false, subscribed: false, animated: true },
  hero:          { active: 0, centered: true, animated: true },
  toggle:        { on: true, animated: true },
  button:        { loading: false, disabled: false, animated: true },
  navbar:        { active: 0, animated: true },
