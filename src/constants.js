...
export const DEFAULT_PROPS = {
  ...
  notification:  { read: [false, false, true], muted: false, showHeader: true, showAvatar: true, showTime: true, animated: true },
  ...
  kanban:        { active: 1, compact: false, showAssignees: true, showPriority: true, showTags: true, animated: true },
