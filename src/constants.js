...
export const DEFAULT_PROPS = {
  ...
  modal:         { on: true, size: 1, dismissible: true, showIcon: true, animated: true },
  ...
  "avatar-row":  { active: 0, stacked: true, showCount: true, animated: true },
  ...
  navbar:        { active: 0, showCta: true, animated: true },
  breadcrumb:    { active: 2, collapsed: false, showHome: true, animated: true },
  ...
  search:        { results: 3, loading: false, clearable: true, showIcon: true, animated: true },
