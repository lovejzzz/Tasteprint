...
export const DEFAULT_PROPS = {
  ...
  "media-player":{ pct: 42, playing: true, liked: false, shuffle: false, muted: false, showTime: true, showCover: true, showArtist: true, showTitle: true, animated: true },
  testimonial:   { stars: 4, verified: 1, showAvatar: true, showName: true, showRole: true, showStars: true, showQuote: true, animated: true },
  rating:        { stars: 4, interactive: true, showCount: true, showAuthor: true, showScore: true, showReviewText: true, animated: true },
  "sub-toggle":  { active: 1, showBadge: true, showLabel: true, showPrice: true, animated: true },
