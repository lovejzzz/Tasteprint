...
export const DEFAULT_PROPS = {
  ...
  "cart-item":   { qty: 1, saved: false, showControls: true, showImage: true, animated: true },
  ...
  "promo-banner":{ dismissed: false, closable: true, showCode: true, showEmoji: true, animated: true },
