...
export const VARIANTS = {
  ...
  "card-sm": ["Rounded","Horizontal","Tinted","Glass","Brutal","Gradient glow","Minimal"],
  hero:      ["Gradient","Centered","Bold fill","Terminal","Glass","Brutal","Gradient glow"],
  ...
  toggle:    ["Round","Square","Labeled","iOS","Brutal","Glass","Gradient"],
  badge:     ["Tinted","Solid","Outline","Glass","Brutal","Gradient","Counter"],
  toast:     ["Card","Dark snack","Accent bar","Glass","Brutal","Gradient","Terminal"],
  progress:  ["Round","Flat","Thin","Striped","Glow","Brutal","Gradient"],
  modal:     ["Card","Minimal","Sheet","Glass","Destructive","Brutal","Gradient"],
  sidebar:   ["Full","Minimal","Grouped","Glass","Brutal","Gradient","Terminal"],
  table:     ["Striped","Bordered","Minimal","Terminal","Glass","Gradient","Brutal"],
  ...
  alert:     ["Tinted","Card","Banner","Glass","Brutal","Gradient","Terminal"],
  ...
  "cart-item":["Standard","Compact","Detailed","Swipe","Brutal","Glass","Gradient glow"],
  "feature-table":["Checkmark","Highlighted","Minimal","Gradient","Glass","Brutal","Gradient glow"],
  "promo-banner":["Gradient","Pill","Countdown","Glass","Social Proof","Brutal","Gradient glow"],
  "order-summary":["Card","Compact","Discount","Itemized","Glass","Brutal","Gradient glow"],
  rating:["Stars","Compact","Review","Sentiment","Breakdown","Brutal","Gradient"],
  receipt:["Dashed","Clean","Digital","Thermal","Glass","Brutal","Gradient glow"],
  "sub-toggle":["Cards","Switch","Pill","Glass","Brutal","Gradient","Terminal"],
  ...
  chat:      ["Bubble","Thread","Terminal","Glass","Gradient","Brutal","Gradient glow"],
  ...
  "tag-input":["Rounded","Square","Outlined","Colorful","Input","Brutal","Gradient glow"],
...
export const DEFAULT_PROPS = {
  ...
  tabs:          { active: 0, showIcon: true, showBadge: true, showDivider: true, animated: true },
  navbar:        { active: 0, showCta: true, animated: true },
  sidebar:       { active: 0, collapsed: false, showHeader: true, showFooter: true, showBadge: true, animated: true },
  pagination:    { active: 2, total: 8, showTotal: true, showArrows: true, showPageNumbers: true, animated: true },
  stepper:       { active: 1, showLabels: true, showDescription: true, showConnectors: true, showNumbers: true, animated: true },
  timeline:      { active: 0, completed: [true, false, false], showConnector: true, showTime: true, showDescription: true, showIcon: true, animated: true },
  accordion:     { open: [true, false, false], showIcon: true, showDivider: true, showDescription: true, animated: true },
  dropdown:      { active: 0, disabled: false, showFlags: true, showChevron: true, showDescription: true, animated: true },
  "cmd-palette": { active: 0, open: true, showHints: true, showIcon: true, showCategory: true, animated: true },
  progress:      { pct: 68, indeterminate: false, striped: false, showLabel: true, showPercentage: true, animated: true },
  slider:        { pct: 65, disabled: false, showValue: true, showTicks: true, animated: true },
  "media-player":{ pct: 42, playing: true, liked: false, shuffle: false, muted: false, showTime: true, showCover: true, showArtist: true, animated: true },
  testimonial:   { stars: 4, verified: 1, showAvatar: true, showName: true, showRole: true, showStars: true, animated: true },
  rating:        { stars: 4, interactive: true, showCount: true, showAuthor: true, showScore: true, animated: true },
  "sub-toggle":  { active: 1, showBadge: true, showLabel: true, animated: true },
  "dash-panel":  { bars: [65,42,78,35,55,88,48], ring: 72, showStatus: true, showLabels: true, showChart: true, animated: true },
  chart:         { bars: [55,80,45,90,65,75], highlight: 3, animated: true, showLegend: true, showGrid: true, showAxisLabels: true },
  notification:  { read: [false, false, true], muted: false, showHeader: true, showAvatar: true, showTime: true, showBadge: true, showDescription: true, animated: true },
  alert:         { level: 0, dismissed: false, showAction: true, showIcon: true, showClose: true, showTitle: true, animated: true },
  toast:         { level: 0, dismissed: false, actionable: true, showIcon: true, showClose: true, showDescription: true, animated: true },
  "pricing-card":{ featured: false, period: 0, annual: false, highlighted: false, showBadge: true, showCta: true, showFeatures: true, animated: true },
  "product-card":{ wishlisted: false, rating: 4, inCart: false, onSale: false, soldOut: false, showPrice: true, showRating: true, showDescription: true, showImage: true, animated: true },
  "profile-card":{ online: true, verified: true, followed: false, showBio: true, showStats: true, showAvatar: true, showCover: true, animated: true },
  kanban:        { active: 1, compact: false, showAssignees: true, showPriority: true, showTags: true, showCount: true, animated: true },
  skeleton:      { loading: true, showAvatar: true, showLines: true, showActions: true, showImage: true, animated: true },
  "bento-grid":  { active: 0, showLabels: true, showIcon: true, showValues: true, animated: true },
  "feature-table":{ highlight: 1, compact: false, showCheck: true, showHeader: true, showCta: true, animated: true },
  "cart-item":   { qty: 1, saved: false, showControls: true, showImage: true, showPrice: true, animated: true },
  receipt:       { tip: 0, paid: 1, showBreakdown: true, showStatus: true, showPayment: true, animated: true },
  "order-summary":{ discount: false, shipping: 0, showItems: true, showCta: true, showBreakdown: true, animated: true },
  "promo-banner":{ dismissed: false, closable: true, showCode: true, showEmoji: true, showCta: true, animated: true },
  ...
  modal:         { on: true, size: 1, dismissible: true, showIcon: true, showFooter: true, showTitle: true, showDescription: true, animated: true },
  "stat-card":   { trend: 0, sparkline: true, showDelta: true, showLabel: true, showIcon: true, animated: true },
  "list-item":   { on: true, pinned: false, completed: false, showDescription: true, showIcon: true, showStatus: true, animated: true },
  "avatar-row":  { active: 0, stacked: true, showCount: true, showStatus: true, showNames: true, animated: true },
  "tag-input":   { active: 0, removable: true, editable: true, showAdd: true, showCount: true, animated: true },
  "card-sm":     { featured: false, showBadge: true, showIcon: true, showDescription: true, animated: true },
  footer:        { active: 0, newsletter: false, subscribed: false, showSocials: true, showCopyright: true, showBrand: true, showLinks: true, animated: true },
  ...
  search:        { results: 3, loading: false, clearable: true, showIcon: true, showCount: true, showShortcut: true, animated: true },
  tooltip:       { on: true, position: 0, showArrow: true, showShortcut: true, showDescription: true, animated: true },
  heading:       { align: 0, size: 0, decorated: false, showSubtitle: true, showCount: true, showOverline: true, animated: true },
