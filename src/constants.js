...
export const DEFAULT_PROPS = {
  ...
  stepper:       { active: 1, showLabels: true, showDescription: true, animated: true },
  ...
  "pricing-card":{ featured: false, period: 0, annual: false, highlighted: false, showBadge: true, showCta: true, animated: true },
  "product-card":{ wishlisted: false, rating: 4, inCart: false, onSale: false, soldOut: false, showPrice: true, showRating: true, animated: true },
  ...
  card:          { featured: false, liked: false, loading: false, showAuthor: true, showCta: true, animated: true },
  badge:         { level: 0, count: 3, dot: false, showLabel: true, animated: true },
  modal:         { on: true, size: 1, dismissible: true, showIcon: true, showFooter: true, animated: true },
  ...
  hero:          { active: 0, centered: true, showTrust: true, showCta: true, animated: true },
  toggle:        { on: true, animated: true },
