...
export const DEFAULT_PROPS = {
  ...
  checkbox:      { checked: [true, false, false], disabled: false, showDescription: true, animated: true },
  ...
  notification:  { read: [false, false, true], muted: false, showHeader: true, showAvatar: true, showTime: true, showBadge: true, animated: true },
  alert:         { level: 0, dismissed: false, showAction: true, showIcon: true, showClose: true, animated: true },
  toast:         { level: 0, dismissed: false, actionable: true, showIcon: true, showClose: true, animated: true },
  ...
  skeleton:      { loading: true, showAvatar: true, showLines: true, showActions: true, animated: true },
  ...
  "list-item":   { on: true, pinned: false, completed: false, showDescription: true, showIcon: true, animated: true },
