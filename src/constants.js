...
export const DEFAULT_PROPS = {
  ...
  accordion:     { open: [true, false, false], showIcon: true, showDivider: true, showDescription: true, showQuestions: true, animated: true },
  dropdown:      { active: 0, disabled: false, showFlags: true, showChevron: true, showDescription: true, showSelectedText: true, animated: true },
  ...
  "product-card":{ wishlisted: false, rating: 4, inCart: false, onSale: false, soldOut: false, showPrice: true, showRating: true, showDescription: true, showImage: true, showTitle: true, animated: true },
  ...
  "card-sm":     { featured: false, showBadge: true, showIcon: true, showDescription: true, showTitle: true, animated: true },
