...
export const DEFAULT_PROPS = {
  ...
  sidebar:       { active: 0, collapsed: false, showHeader: true, showFooter: true, animated: true },
  pagination:    { active: 2, total: 8, showTotal: true, showArrows: true, showPageNumbers: true, animated: true },
  stepper:       { active: 1, showLabels: true, showDescription: true, showConnectors: true, animated: true },
  timeline:      { active: 0, completed: [true, false, false], showConnector: true, showTime: true, showDescription: true, animated: true },
  ...
  input:         { focused: false, error: false, disabled: false, success: false, showHelper: true, showLabel: true, animated: true },
  select:        { active: 0, disabled: false, searchable: false, showFlag: true, showLabel: true, animated: true },
