...
export const DEFAULT_PROPS = {
  ...
  timeline:      { active: 0, completed: [true, false, false], showConnector: true, showTime: true, animated: true },
  ...
  "media-player":{ pct: 42, playing: true, liked: false, shuffle: false, muted: false, showTime: true, animated: true },
