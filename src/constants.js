...
export const DEFAULT_PROPS = {
  ...
  "profile-card":{ online: true, verified: true, followed: false, showBio: true, showStats: true, animated: true },
  kanban:        { active: 1, compact: false, showAssignees: true, showPriority: true, animated: true },
  ...
  footer:        { active: 0, newsletter: false, subscribed: false, showSocials: true, showCopyright: true, animated: true },
