...
export const DEFAULT_PROPS = {
  ...
  timeline:      { active: 0, completed: [true, false, false], showConnector: true, animated: true },
  accordion:     { open: [true, false, false], showIcon: true, animated: true },
  dropdown:      { active: 0, disabled: false, showFlags: true, animated: true },
  "cmd-palette": { active: 0, open: true, showHints: true, animated: true },
  ...
  kanban:        { active: 1, compact: false, showAssignees: true, animated: true },
