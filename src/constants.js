...
export const DEFAULT_PROPS = {
  ...
  "media-player":{ pct: 42, playing: true, liked: false, shuffle: false, muted: false },
  testimonial:   { stars: 4, verified: 1, animated: true },
  rating:        { stars: 4, interactive: true, showCount: true },
  ...
  "pricing-card":{ featured: false, period: 0, annual: false, highlighted: false },
  "product-card":{ wishlisted: false, rating: 4, inCart: false, onSale: false, soldOut: false },
  ...
  table:         { highlight: 0, sortCol: -1, sortable: true },
  card:          { featured: false, liked: false, loading: false },
  ...
  "list-item":   { on: true, pinned: false, completed: false },
  "avatar-row":  { active: 0, stacked: true },
  "tag-input":   { active: 0, removable: true, editable: true, animated: true },
  "card-sm":     { featured: false },
  footer:        { active: 0, newsletter: false, subscribed: false },
