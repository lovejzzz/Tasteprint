...
export const DEFAULT_PROPS = {
  ...
  alert:         { level: 0, dismissed: false, showAction: true, showIcon: true, showClose: true, showTitle: true, showDescription: true, animated: true },
  ...
  "list-item":   { on: true, pinned: false, completed: false, showDescription: true, showIcon: true, showStatus: true, showTitle: true, animated: true },
