...
export const DEFAULT_PROPS = {
  ...
  testimonial:   { stars: 4, verified: 1, showAvatar: true, showName: true, showRole: true, showStars: true, showQuote: true, animated: true },
  ...
  "dash-panel":  { bars: [65,42,78,35,55,88,48], ring: 72, showStatus: true, showLabels: true, showChart: true, showTrend: true, showRing: true, animated: true },
  chart:         { bars: [55,80,45,90,65,75], highlight: 3, animated: true, showLegend: true, showGrid: true, showAxisLabels: true, showTitle: true, showDataPoints: true },
  ...
  "pricing-card":{ featured: false, period: 0, annual: false, highlighted: false, showBadge: true, showCta: true, showFeatures: true, showPrice: true, animated: true },
  ...
  "profile-card":{ online: true, verified: true, followed: false, showBio: true, showStats: true, showAvatar: true, showCover: true, showSocials: true, animated: true },
  kanban:        { active: 1, compact: false, showAssignees: true, showPriority: true, showTags: true, showCount: true, showDueDate: true, animated: true },
  ...
  "cart-item":   { qty: 1, saved: false, showControls: true, showImage: true, showPrice: true, showVariant: true, animated: true },
  ...
  "stat-card":   { trend: 0, sparkline: true, showDelta: true, showLabel: true, showIcon: true, showValue: true, animated: true },
