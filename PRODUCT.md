...
- **Test coverage:** All hooks (useDesigner, useHistory, useViewport, useKeyboard, usePicky, useTpApi), all components (Header, PropsPanel, LibrarySidebar, MobileDrawer, ShapeItem, PickyOverlay, PickyCard, ErrorBoundary, App, ComponentRenderer — 300+ smoke tests across all type×variant combos), core utils (load, snap, debounce, sanitizeHtml, validateImport, getTextureStyle, getReadableTextColor, designerRandomize, designScore), constants integrity + orphan detection
